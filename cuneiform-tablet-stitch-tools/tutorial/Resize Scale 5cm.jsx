...
var newSizeOfRuler = length * 5;
var percentageOfNewSizeOfRuler = newSizeOfRuler * 100 / 590;
activeDocument.activeLayer = activeDocument.layers.getByName("BM_5cm_scale");

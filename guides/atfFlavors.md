...
* `$` for `Is not a logogram` (see the [inline tutorial](http://oracc.museum.upenn.edu/doc/help/editinginatf/primer/inlinetutorial/index.html#d2e18948)) is not supported. It should be removed from the text.
...
See the [Archibab website](http://www.archibab.fr/)

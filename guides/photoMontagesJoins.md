...
| :---: | :---: |
| <img src="images/photomon_fg-frag.png" alt="Foreground fragment example" width="50%"> | <img src="images/photomon_bg-frag.png" alt="Background fragment example" width="50%"> |
...
* Select _Crop Tool_ by clicking on **[<img src="images/photomon_crop.png" alt="Crop Tool icon" width="3%">]** or by pressing **[Shift]** + **[C]**
...
<img src="images/photomon_header.png" alt="GIMP thumbnail header" width="40%">
...
| :---: | :---: |
| <img src="images/photomon_cropping-1.png" alt="Correct cropping section" width="50%"> | <img src="images/photomon_cropping-2.png" alt="Problematic cropping section" width="50%"> |

* Select _Fuzzy Select Tool_ by clicking on **[<img src="images/photomon_fuzzy.png" alt="Fuzzy Select Tool icon" width="3%">]** or by pressing **[U]**
...
<img src="images/photomon_layers.png" alt="GIMP layers panel" width="30%">

* The main tools you will need to transform fragments are:
  * The _Move Tool_ (**[<img src="images/photomon_move.png" alt="Move Tool icon" width="3%">]** or **[M]**)
  * The _Rotate Tool_ (**[<img src="images/photomon_rotate.png" alt="Rotate Tool icon" width="3%">]** or **[Shift]** + **[R]**)
  * The _Scale Tool_ (**[<img src="images/photomon_transf.png" alt="Scale Tool icon" width="3%">]** or **[Shift]** + **[T]**) - hold **[Shift]** to maintain aspect ratio
...
* For this, select _Text Tool_ (**[<img src="images/photomon_text.png" alt="Text Tool icon" width="2%">]** or **[T]**))
